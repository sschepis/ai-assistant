        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                try {
                    ...
                    filePath = path.startsWith('/') ? path : "".concat(installDir, "/").concat(path);
                    fs_1.default.writeFileSync(filePath, content);
                    return [2 /*return*/, "File saved to ".concat(filePath)];
                }
                catch (error) {
                    return [2 /*return*/, "Error saving file: ".concat(error.message)];
                }
                return [2 /*return*/];
            });
        });
